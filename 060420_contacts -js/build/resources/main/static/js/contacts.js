...
document.addEventListener("DOMContentLoader", function main() {
...
// }
//
// addContactForm.addEventListener("click", function () {
//     console.log("listen to form");
//
// })

//like a controller in Java.It listen dif events from
class ContactFormListener {
    ...
    handleEvent(event) {
        ...
        if(action === undefined)
            return;
        this[action](); //action - method's name; this["add]()
    }
